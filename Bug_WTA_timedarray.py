...
A1 = TimedArray((1,0),dt=3000*ms)
A2 = TimedArray((0,1),dt=3000*ms)
...
L = 30*Hz  #Decreasing will make a slower turning when it senses target
alpha = 0.05 #.2 # 0.25
...
M2 = StateMonitor(sl2, ('v', 'I'), record=True)
...
figure(1)
plot(ML.t/ms, ML.v[0],label='voltage1 green')
figure(2)
plot(M2.t/ms, M2.v[0],label='voltage2 blue')
plt.legend()
...
#plot(MR2.t/ms, MR2.r[0])
#figure(3)
plot(MR.t/ms, MR.r[0],label='rate1 green')
plot(MR2.t/ms, MR2.r[0],label='rate2 blue')
plt.legend()
...
fig = go.Figure(
    ...
    layout=go.Layout(
        ...
        height=600,
        width=600,
        title_text="WTA", hovermode="closest",
